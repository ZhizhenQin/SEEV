...
def main(args):
    ...
    dynamics_model = ObsAvoidSI(buffer_range=args.buffer_range)
    ...
    V_contour_experiment = CLFContourExperiment(
        ...
        n_grid=25,
        x_axis_index=ObsAvoidSI.X,
        y_axis_index=ObsAvoidSI.Y,
        x_axis_label="$x$",
        y_axis_label="$y$",
    )
    rollout_state_space_experiment = RolloutStateSpaceExperiment(
        "Rollout State Space",
        start_x,
        plot_x_index=ObsAvoidSI.X,
        plot_x_label="$x$",
        plot_y_index=ObsAvoidSI.Y,
        plot_y_label="$y$",
    ...
    model_name = (
        "obs_avoid_si_commit_{}_layers_{}_size_{}_seed_{}_certify_{}_reg_{}_buffer_{}".format(
            current_git_hash(),
            cbf_hidden_layers,
            cbf_hidden_size,
            args.random_seed,
